...
return [
    ...
    'custom' => [
        'users' => [
            'unique' => 'Os usuarios introducidos non son novos.',
            'empty_not_manager' => 'Debes introducir alomenos un usuario como membro deste proxecto e que non sexas ti mesmo.',
        ],
        'unreachable' => 'A información introducida non é válida e non era esperada.',
        'attribute-name' => [

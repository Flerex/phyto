...
return [
    ...
    'projects' => [
        ...
        'tasks' => [
            ...
            'process_explained' => 'Here you can select how many times this sample will be tagged. For every process, the assignments for every member will be unique. This means that the same person won’t be assigned the same image in different processes.',
